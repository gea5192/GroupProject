...
var products = [
{ id: 1, name: "Penn State Crew Neck Sweatshirt", price: 47.99 },
{ id: 2, name: "Penn State Stainless Steel Tumbler", price: 25.99 },
{ id: 3, name: "Penn State Football Hooded Sweatshirt", price: 62.99 }
];
...
if (password.length < 6) { messages.push("Password must be at least 6 characters."); } // Validate password confirmation
    if (password !==confirmPassword) { messages.push("Passwords do not match"); } // Display validation messages or
    success message if (messages.length> 0) {
