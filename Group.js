...
var products = [
{ id: 1, name: "Penn State Crew Neck Sweatshirt", description: "Cozy sweatshirt", category: "Clothing", uom: "Piece",
...
if (password.length < 6) messages.push("Password must be at least 6 characters."); if (password !==confirmPassword)
    messages.push("Passwords do not match"); // Display validation messages or success message if (messages.length> 0) {
